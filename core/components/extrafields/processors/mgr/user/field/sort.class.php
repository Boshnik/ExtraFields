...
class ExtraUserFieldSortProcessor extends modObjectProcessor
{
    ...
    /**
     * @param ExtraUserField $source
     * @param ExtraUserField $target
     *
     * @return array|string
     */
    public function sort(ExtraUserField $source, ExtraUserField $target)
    {
...
return 'ExtraUserFieldSortProcessor';