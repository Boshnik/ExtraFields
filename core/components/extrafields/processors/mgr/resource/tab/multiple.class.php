...
class ExtraResourceTabMultipleProcessor extends modProcessor
{
    ...
    public function process()
    {
        ...
        foreach ($ids as $id) {
            ...
            $response = $extrafields->runProcessor('mgr/resource/tab/' . $method, ['id' => $id]);
            if ($response->isError()) {
...
return 'ExtraResourceTabMultipleProcessor';