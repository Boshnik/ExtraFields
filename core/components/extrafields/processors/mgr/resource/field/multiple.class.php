...
class ExtraResourceFieldMultipleProcessor extends modProcessor
{
    ...
    public function process()
    {
        ...
        foreach ($ids as $id) {
            ...
            $response = $extrafields->runProcessor('mgr/resource/field/' . $method, ['id' => $id]);
            if ($response->isError()) {
...
return 'ExtraResourceFieldMultipleProcessor';