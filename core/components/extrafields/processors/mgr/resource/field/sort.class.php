...
class ExtraResourceFieldSortProcessor extends modObjectProcessor
{
    ...
    public function process()
    {
        ...
        foreach ($sources as $id) {
            /** @var ExtraResourceField $source */
            $source = $this->modx->getObject($this->classKey, compact('id'));
            /** @var ExtraResourceField $target */
    ...
    /**
     * @param ExtraResourceField $source
     * @param ExtraResourceField $target
     *
     * @return array|string
     */
    public function sort(ExtraResourceField $source, ExtraResourceField $target)
    {
...
return 'ExtraResourceFieldSortProcessor';