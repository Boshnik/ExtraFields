...
/**
 * The PbBlock manager controller for ExtraFields.
 */
class ExtraFieldsPbBlockManagerController extends modExtraManagerController
{
    ...
    public function loadCustomCssJs()
    {
        ...
        $config['class_name'] = 'pbBlockValue';
