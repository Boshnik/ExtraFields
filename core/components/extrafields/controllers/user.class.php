...
/**
 * The user manager controller for ExtraFields.
 *
 */
class ExtraFieldsUserManagerController extends modExtraManagerController
{
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($jsUrl . 'panel/user.js');
        $this->addJavascript($jsUrl . 'page/user.js');
    ...
    {
        $this->content .= '<div id="ef-panel-user-div"></div>';
